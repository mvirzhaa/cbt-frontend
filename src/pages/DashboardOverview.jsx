...
export default function DashboardOverview() {
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="max-w-5xl mx-auto space-y-6">
            ...
            {/* KARTU STATISTIK - LEBIH COMPACT (Padat) */}
                ...
                <div className="bg-gradient-to-br from-[#0f4c3a] to-[#16654e] rounded-xl p-5 text-white shadow-md relative overflow-hidden group border border-[#1f7a63]">
                    ...
                    <div className="relative z-10">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-[#6ee7b7] font-bold uppercase tracking-widest text-[10px] mb-2">Sesi Ujian Aktif</p>
                                <h4 className="text-3xl font-black tracking-tight">4 <span className="text-lg font-bold text-[#a7f3d0] ml-1">Sesi</span></h4>
                            </div>
                ...
                <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm relative overflow-hidden group hover:border-amber-400/50 transition-all duration-300">
                    ...
                    <div className="flex justify-between items-start relative z-10">
                        <div>
                            ...
                            <h4 className="text-3xl font-black text-slate-800 tracking-tight">12 <span className="text-lg font-bold text-slate-400 ml-1">Berkas</span></h4>
                        </div>
                ...
                <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm relative overflow-hidden group hover:border-blue-400/50 transition-all duration-300">
                    ...
                    <div className="flex justify-between items-start relative z-10">
                        <div>
                            ...
                            <h4 className="text-3xl font-black text-slate-800 tracking-tight">128 <span className="text-lg font-bold text-slate-400 ml-1">Butir</span></h4>
                        </div>
            ...
            {/* Tabel Jadwal - Diperkecil & Dipadatkan */}
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden relative">
                <div className="px-5 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                    <div>
                        <h3 className="text-[15px] font-black text-slate-800 tracking-tight">Jadwal Ujian Hari Ini</h3>
                    </div>
                    ...
                    <table className="w-full text-left border-collapse whitespace-nowrap">
                        <thead>
                            <tr className="border-b border-slate-100 bg-white">
                                ...
                                <th className="py-3 px-5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Waktu</th>
                        ...
                        <tbody>
                            <tr className="border-b border-slate-50 hover:bg-blue-50/30 transition-colors group">
                                <td className="py-3 px-5">
                                    <div className="font-bold text-slate-800 text-[13px] group-hover:text-blue-700 transition-colors">Pemrograman Web Lanjut</div>
                                    <div className="text-[11px] font-semibold text-slate-400 mt-0.5">Kode: IF101 • SKS: 3</div>
                                </td>
                                <td className="py-3 px-5 text-center">
                                    <span className="font-mono text-[13px] font-black text-slate-700 bg-slate-100 border border-slate-200 px-2.5 py-1 rounded-md tracking-wider">B25AD5</span>
                                </td>
                                <td className="py-3 px-5 text-center">
                                    <div className="font-bold text-slate-700 text-[13px]">Hingga 15:00 WIB</div>
                                    <div className="text-[11px] font-semibold text-slate-400 mt-0.5">Durasi: 90 Menit</div>
                                </td>
                                <td className="py-3 px-5 text-right">
                                    <span className="inline-flex items-center gap-1.5 bg-[#e6f4ea] text-[#0f4c3a] border border-[#ceead6] font-bold px-3 py-1 rounded-md text-[10px] uppercase tracking-wider">
